...
## Version journey (v1.0 â†’ v2.1)

### v1.0 â€” The original "Daily Journal" idea
...
### v1.2 â€” UI/UX refresh + 5-activity column system
...
### v1.3 â€” Colored dropdown activity selection
...
### v1.4 â€” Fixed activity names + completion checkboxes + daily overall %
...
### v1.5 â€” Per-activity percentage dropdown + daily completion % output
...
### v1.6 â€” Dashed-style daily completion overview
...
### v1.7 â€” Per-cell dashed bars + meaningful color logic + linear daily overview bar
...
### v1.8 â€” Massive UI redesign (theme-based progress dropdowns)
...
### v1.9 â€” Compare months + Customize activity names (built for all users)
...
## v2.0 â€” Streaks + better overview clarity
...
## v2.1 â€” Current version (login + cloud sync + streaks)
